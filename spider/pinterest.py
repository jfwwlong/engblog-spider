...
class PinterestCrawler(BaseCrawler):
    ...
    def crawl_next_batch(self):
        ...
        while True:
            ...
            response = requests.get('https://medium.com/pinterest-engineering/load-more?sortBy=latest', params=params,
    ...
    def convert_blog(self, blog):
        return {
            'title': blog['title'],
            'url': 'https://medium.com/pinterest-engineering/{}'.format(blog['uniqueSlug']),
